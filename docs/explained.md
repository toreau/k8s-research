...
Et container-bilde har en adresse (`ghcr.io/toreau/astronomy-api`) og en **digest**: `sha256:a7536683f9…`. Digest-en er en kryptografisk hash av bildeinnholdet — praktisk talt en unik fingeravtrykk. Én digest ↔ nøyaktig ett innhold. Hvis noen endrer bildet på noen som helst måte, blir digest-en annerledes.
